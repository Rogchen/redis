jQuery.extend({
	...
	ajaxUpload : function(s, xml) {
		...
		var jForm = $('<form action="' + s.url + '" target="' + idIO + '" method="post" enctype="multipart/form-data"></form>').appendTo(
				'body');
	...
	createUploadForm : function(id, url, fileElementId, data) {
		...
		var form = jQuery('<form  action="' + url + '" method="POST" name="' + formId + '" id="' + formId
