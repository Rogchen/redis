...
$(function(){
	$("#cityqh").hover(function(){
		$(this).children(".cityul").show();
		},function(){
			$(this).children(".cityul").hide();
	});
	$(".cityul dd a").click(function(){
		$(".cityDropdownBtn a").html($(this).html());
	});
	

	$("#aboutzfhli").hover(function(){
		$("#aboutzfha").addClass("aboutzfha");
			$(".topDropDown").show();
		},function(){
			$("#aboutzfha").removeClass("aboutzfha");
			$(".topDropDown").hide();
	});
	 ...
	 $("#myShop").hover(function(){
		$("#aboutzfhab").addClass("aboutzfhab");
			$(".topDropDowna").show();
		},function(){
			$("#aboutzfhab").removeClass("aboutzfhab");
			$(".topDropDowna").hide();
	 });
	 
	 $("#toprCart").hover(function(){
		$("#toprCartid").addClass("toprCartb");
      	$(".toprCartDown").show();
	},function(){
		$("#toprCartid").removeClass("toprCartb");
		$(".toprCartDown").hide();
	});
