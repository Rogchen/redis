			...
			return this.each(function(){
				...
				setTimeout(function(){
					...
					$("a", $this).click(function(event){
						...
						//关闭右侧页面
						$("#addChildDiv").hide();
						//与content.js结合，增加显示右键菜单
						//context.init({preventDoubleContext: true});
						//context.settings({compress: true});//如果设置为TRUE，上下文菜单将有更少的填充
//					    context.attach($li, [
//					        {header: '工具栏'},
//					        {text: '增加子级', href: 'javascript:addChild(\''+$(this).attr("tname")+'\',\''+$(this).attr("tvalue")+'\')'},
//					        {divider: true},
//							{text: '编辑当前', href: 'javascript:edit(\''+$(this).attr("tname")+'\',\''+$(this).attr("tvalue")+'\')'},
//					    ]);
