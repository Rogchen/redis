...
//        if(requestURI != null && requestURI.contains("/admin/sa")){
//            // 跳过手机端
//            response.sendRedirect("/blog/front/blogIndex.html");
//            return true;
//        }
//        if(requestURI != null && requestURI.contains("/admin/sa/adminManage/main")) {
////        response.sendRedirect("/admin/sa/adminManage/main");
//            return true;
//        }else{
//            response.sendRedirect("/admin/sa/adminManage/main");
//            return false;
